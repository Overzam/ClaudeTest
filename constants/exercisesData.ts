...
export const STATIC_EXERCISES: Record<string, Exercise[]> = {
  ...
  // ── ITALIAN (new lessons it-7 to it-20) ───────────────────────────────────

  "L'Huile d'Olive": [
    { id: 'local-it1-1', lessonId: 'it-1', orderIndex: 0, xpReward: 10,
      type: 'multiple_choice',
      question: 'L\'huile d\'olive "extra vierge" est définie par :',
      data: { options: ['Première pression à froid, acidité < 0,8%, sans défaut organoleptique', 'Deuxième pression, acidité < 2%', 'Mélange d\'huiles raffinées et vierge', 'Huile chauffée à haute température'], correctIndex: 0,
        anecdote: 'La Grèce a la consommation d\'huile d\'olive par habitant la plus haute du monde (20 kg/an). L\'huile d\'olive italienne DOP (Dénomination d\'Origine Protégée) représente 38 appellations différentes.' } },
    { id: 'local-it1-2', lessonId: 'it-1', orderIndex: 1, xpReward: 10,
      type: 'association',
      question: 'Associe chaque région italienne à son profil d\'huile d\'olive :',
      data: { pairs: [
        { left: 'Toscane', right: 'Intense, poivrée, herbe fraîche' },
        { left: 'Sicile', right: 'Fruitée, dorée, artichaut' },
        { left: 'Ligurie', right: 'Douce, délicate — idéale pour le pesto' },
        { left: 'Pouilles', right: 'Robuste, grande production italienne' },
      ] } },
    { id: 'local-it1-3', lessonId: 'it-1', orderIndex: 2, xpReward: 10,
      type: 'fill_in_blank',
      question: 'Pour préserver une huile d\'olive de qualité, on la conserve à l\'abri de la lumière, de la chaleur et de l\'___ (oxydation).',
      data: { answer: 'air', hint: 'L\'oxygène rancit les corps gras' } },
  ],

  'Les Pâtes Fraîches': [
    { id: 'local-it2-1', lessonId: 'it-2', orderIndex: 0, xpReward: 10,
      type: 'multiple_choice',
      question: 'La farine idéale pour les pâtes fraîches est :',
      data: { options: ['Farine "00" (très fine) ou semoule de blé dur extra-fine', 'Farine T55 ordinaire', 'Farine de riz', 'Maïzena'], correctIndex: 0,
        anecdote: 'La proportion classique italienne est 100g de farine pour 1 œuf entier. Dans certaines régions (Émilie-Romagne), on utilise uniquement des jaunes d\'œuf pour des tagliatelle plus riches et jaunes.' } },
    { id: 'local-it2-2', lessonId: 'it-2', orderIndex: 1, xpReward: 10,
      type: 'fill_in_blank',
      question: 'Après pétrissage, la pâte à pâtes fraîches doit reposer enveloppée dans du film alimentaire pendant au moins ___ avant d\'être étalée.',
      data: { answer: '30 minutes', hint: 'Le gluten doit se détendre pour une pâte souple' } },
    { id: 'local-it2-3', lessonId: 'it-2', orderIndex: 2, xpReward: 10,
      type: 'multiple_choice',
      question: 'Les pâtes fraîches cuisent beaucoup plus vite que les pâtes sèches, en :',
      data: { options: ['1 à 3 minutes dans l\'eau bouillante salée', '8 à 12 minutes', '5 à 7 minutes', '15 à 20 minutes'], correctIndex: 0 } },
  ],

  'La Pizza Napoletana': [
    { id: 'local-it3-1', lessonId: 'it-3', orderIndex: 0, xpReward: 10,
      type: 'multiple_choice',
      question: 'La pizza napoletana DOC (appellation officielle) doit être cuite dans un four :',
      data: { options: ['À bois à 450-485°C pendant 60 à 90 secondes', 'Électrique à 250°C pendant 15 min', 'À gaz à 300°C', 'Infrarouge pendant 5 min'], correctIndex: 0,
        anecdote: 'La Vera Pizza Napoletana est protégée par le "Disciplinare STG" depuis 2010. La margherita a été créée en 1889 en hommage à la reine Margherita — ses couleurs représentent le drapeau italien.' } },
    { id: 'local-it3-2', lessonId: 'it-3', orderIndex: 1, xpReward: 10,
      type: 'fill_in_blank',
      question: 'La pâte à pizza napolitaine doit lever minimum ___ heures (idéalement 24-72h) pour développer saveur et structure alvéolaire.',
      data: { answer: '8', hint: 'La longue fermentation est le secret de la légèreté' } },
    { id: 'local-it3-3', lessonId: 'it-3', orderIndex: 2, xpReward: 10,
      type: 'multiple_choice',
      question: 'La sauce tomate de la pizza napoletana est préparée :',
      data: { options: ['Crue — tomates San Marzano écrasées à la main, sans cuisson', 'Cuite 30 min avec ail et herbes', 'À partir de concentré de tomate', 'Avec des tomates cerises fraîches'], correctIndex: 0 } },
  ],

  'Le Tiramisu': [
    { id: 'local-it4-1', lessonId: 'it-4', orderIndex: 0, xpReward: 10,
      type: 'multiple_choice',
      question: '"Tiramisù" signifie en italien :',
      data: { options: ['"Remonte-moi le moral" (tira = tire, mi = moi, su = en haut)', '"Dessert de Venise"', '"Crème au café"', '"Savoiardi trempés"'], correctIndex: 0,
        anecdote: 'L\'origine du tiramisu est disputée entre plusieurs restaurants de Vénétie (Trévise, Tolmezzo). Sa première mention écrite date de 1981. Les Américains en ont découvert une version dans les années 1980, popularisant le dessert mondialement.' } },
    { id: 'local-it4-2', lessonId: 'it-4', orderIndex: 1, xpReward: 10,
      type: 'fill_in_blank',
      question: 'La crème du tiramisu est obtenue en fouettant du mascarpone avec des ___ et du sucre, sans cuisson.',
      data: { answer: 'jaunes d\'œuf', hint: 'Le mascarpone n\'est pas une crème — il ne se fouette pas seul' } },
    { id: 'local-it4-3', lessonId: 'it-4', orderIndex: 2, xpReward: 10,
      type: 'multiple_choice',
      question: 'Pour une version tiramisu sans risque (œufs crus), on peut :',
      data: { options: ['Pasteuriser les jaunes au bain-marie à 60°C ou utiliser des œufs pasteurisés', 'Remplacer les œufs par de la crème fouettée uniquement', 'Cuire la crème 5 min à la casserole', 'Omettre les jaunes et ajouter plus de sucre'], correctIndex: 0 } },
  ],

  'Le Risotto': [
    { id: 'local-it5-1', lessonId: 'it-5', orderIndex: 0, xpReward: 10,
      type: 'multiple_choice',
      question: 'Quel riz est indispensable pour un risotto crémeux ?',
      data: { options: ['Arborio, Carnaroli ou Vialone Nano (riz à grains ronds riches en amidon)', 'Riz basmati', 'Riz long grain', 'Riz complet'], correctIndex: 0,
        anecdote: 'Le risotto est né en Lombardie au XIXe siècle. La mantecatura finale (incorporation du beurre froid hors du feu) est la technique clé qui crée le "all\'onda" — la vague de crémeux qui se propage dans le riz.' } },
    { id: 'local-it5-2', lessonId: 'it-5', orderIndex: 1, xpReward: 10,
      type: 'fill_in_blank',
      question: 'La technique finale du risotto où on incorpore beurre froid et parmesan hors du feu s\'appelle la ___.',
      data: { answer: 'mantecatura', hint: 'Mot italien signifiant "crémer, rendre onctueux"' } },
    { id: 'local-it5-3', lessonId: 'it-5', orderIndex: 2, xpReward: 10,
      type: 'step_ordering',
      question: 'Remets les étapes du risotto dans l\'ordre :',
      data: {
        steps: ['Mantecatura : beurre + parmesan hors feu', 'Toaster le riz 2 min dans le soffritto', 'Déglacer au vin blanc', 'Ajouter le bouillon chaud louche par louche'],
        correctOrder: [1, 2, 3, 0],
      } },
  ],

  'La Carbonara Authentique': [
    { id: 'local-it6-1', lessonId: 'it-6', orderIndex: 0, xpReward: 10,
      type: 'multiple_choice',
      question: 'La recette authentique de la carbonara romaine ne contient pas :',
      data: { options: ['De crème fraîche — jamais', 'D\'oignon', 'De guanciale', 'De pecorino romano'], correctIndex: 0,
        anecdote: 'La carbonara est mentionnée pour la première fois en 1952. Le guanciale (joue de cochon) est irremplaçable — la pancetta n\'a pas le même gras. L\'émulsion jaune d\'œuf + pecorino crée la sauce sans crème ni chaleur directe.' } },
    { id: 'local-it6-2', lessonId: 'it-6', orderIndex: 1, xpReward: 10,
      type: 'fill_in_blank',
      question: 'Pour éviter que les œufs cuisent en omelette, on verse les pâtes hors du feu sur la crème œuf-pecorino, en ajoutant ___ pour fluidifier.',
      data: { answer: 'eau de cuisson', hint: 'L\'amidon de l\'eau de cuisson aide à lier la sauce' } },
    { id: 'local-it6-3', lessonId: 'it-6', orderIndex: 2, xpReward: 10,
      type: 'multiple_choice',
      question: 'Le fromage utilisé dans la carbonara romaine authentique est :',
      data: { options: ['Pecorino romano (brebis) — ou moitié pecorino moitié parmesan', 'Parmesan uniquement', 'Mozzarella', 'Grana Padano'], correctIndex: 0 } },
  ],
