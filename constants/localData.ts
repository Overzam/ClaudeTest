...
export const LOCAL_LESSONS: Record<string, Lesson[]> = {
  'path-french': [
    ...
    { id: 'fr-16', path_id: 'path-french', title: 'Les Œufs Cocotte',           description: 'Œufs en ramequin, crème et fines herbes',            order_index: 15, xp_reward: 30, thumbnail_url: null },
  ...
  'path-japanese': [
    ...
    { id: 'jp-12', path_id: 'path-japanese', title: "L'Onigiri",                 description: 'Triangle de riz farci emballé de nori',              order_index: 11, xp_reward: 30, thumbnail_url: null },
    { id: 'jp-13', path_id: 'path-japanese', title: 'Le Teriyaki',               description: 'Laquage sucré-salé au mirin et sauce soja',          order_index: 12, xp_reward: 35, thumbnail_url: null },
    { id: 'jp-14', path_id: 'path-japanese', title: "L'Udon Maison",             description: 'Nouilles épaisses dans bouillon tsuyu',              order_index: 13, xp_reward: 45, thumbnail_url: null },
    ...
    { id: 'jp-20', path_id: 'path-japanese', title: 'Le Parfait Matcha',         description: 'Crème glacée, gelée, mochi et azuki',                order_index: 19, xp_reward: 60, thumbnail_url: null },
  ],
  'path-moroccan': [
