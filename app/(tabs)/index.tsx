...
const QUICK_TIPS = [
  ...
  "Congelez les herbes fraîches dans de l'huile d'olive en glaçons.",
  ...
  "Le sel de finition (fleur de sel, sel fumé) doit être ajouté au dernier moment.",
  "Chauffez votre poêle avant d'ajouter l'huile — elle est prête quand l'huile brille.",
  "Un oignon caramélisé prend 30 minutes à feu doux, pas 5 minutes.",
  "Conservez vos blancs d'œufs au congélateur — ils se montrent encore mieux congelés.",
  "Pour un risotto crémeux : l'amidon se libère par frottement, pas par trempage.",
  "Ajoutez une feuille de laurier dans l'eau de cuisson du riz : parfum délicat.",
  "Le gingembre se râpe congelé — il se râpe plus finement et se conserve des mois.",
  "Chaque minute de repos du steak sur planche = 5°C de moins en surface.",
  "Un peu de vinaigre dans l'eau de pochage des œufs accélère la coagulation du blanc.",
  "La règle des sauces : goûtez, rectifiez, puis laissez reposer 2 min avant de goûter à nouveau.",
  "Les légumes racines cuisent départ eau froide, les légumes verts départ eau bouillante.",
  "Frotter un moule de beurre puis de cacao (pas de farine) pour les gâteaux au chocolat.",
  "Le beurre noisette se fait en 5 minutes — ne le quittez pas des yeux.",
  "Une crème fouettée tient mieux si le bol et les fouets sont bien froids.",
  "Pour décortiquer une écrevisse facilement : tenez la tête, tournez la queue et tirez.",
  "Le pain rassis se transforme en chapelure maison : mixez et conservez au congélateur.",
  "Vos couteaux ne vont jamais au lave-vaisselle — l'eau chaude abîme les lames et les manches.",
  "Un trait d'huile de sésame grillé se met APRÈS la cuisson, jamais pendant — il brûle.",
  "Le sel sur un avocat oxydé fait des miracles : frottez et laissez agir 1 minute.",
  "Pour un caramel sans cristallisation : ne remuez jamais pendant la cuisson du sucre.",
  "La pâte à pizza ne doit jamais être pétrie avec un rouleau — étirez-la à la main.",
  "Ajoutez la moitié du vin demandé dans la recette — vous pouvez toujours en remettre.",
  "Un œuf frais coule au fond dans un verre d'eau, un œuf vieux flotte.",
  "Votre four chauffe rarement à la bonne température — investissez dans un thermomètre de four.",
  "Le jus de cuisson est de l'or : déglacez toujours avant de laver la poêle.",
  "Pour émonder les tomates : entaillez en croix, 30 secondes eau bouillante, eau glacée — la peau part seule.",
  "Le chocolat chauffe vite — travaillez-le au bain-marie et ne dépassez jamais 50°C.",
];
